...
const ProfileCard = ({ profilePic, Name, Role, Location, Gender }) => {
    return (
        <div className="flex flex-col h-3/5 items-center justify-center w-[260px] md:w-64 bg-white shadow-custom-medium transition duration-300 ease-in-out rounded-lg py-8 px-4 mx-auto max-w-md">
            <div className='w-5 h-5 bg-green-400 rounded-full absolute -mt-[250px] -ml-[180px]  md:-mt-[250px] md:-ml-[200px]'></div>
            <img
                src={profilePic}
                alt="Profile Picture"
